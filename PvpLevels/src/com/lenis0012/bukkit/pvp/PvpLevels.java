...
import com.lenis0012.bukkit.pvp.commands.ReloadCommand;
...
public class PvpLevels extends JavaPlugin {
	...
	public Object getReward(String level, String value) {
		System.out.println("rewards.level."+level+"."+value);
		if(level != null) {
			if(this.rewards.contains("rewards.level."+level))
				return this.rewards.get("rewards.level."+level+"."+value);
			else
